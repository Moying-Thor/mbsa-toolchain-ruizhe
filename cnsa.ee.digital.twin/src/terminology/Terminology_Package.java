...
public interface Terminology_Package extends EPackage {
	 ...
	 * @generated
	 */
	String eNS_URI = "http://cnsa.ee.digital.twin/terminology";
	 ...
	 * @ordered
	 */
	int TERMINOLOGY_GROUP__EXTERNAL_REFERENCE = TERMINOLOGY_ELEMENT__EXTERNAL_REFERENCE;
	 ...
	 * @ordered
	 */
	int TERMINOLOGY_PACKAGE_BINDING__EXTERNAL_REFERENCE = TERMINOLOGY_PACKAGE__EXTERNAL_REFERENCE;
	 ...
	 * @ordered
	 */
	int CATEGORY__EXTERNAL_REFERENCE = TERMINOLOGY_ASSET__EXTERNAL_REFERENCE;
	 ...
	 * @ordered
	 */
	int EXPRESSION_ELEMENT__EXTERNAL_REFERENCE = TERMINOLOGY_ASSET__EXTERNAL_REFERENCE;
	 ...
	 * @ordered
	 */
	int EXPRESSION__EXTERNAL_REFERENCE = EXPRESSION_ELEMENT__EXTERNAL_REFERENCE;
	 ...
	 * @ordered
	 */
	int TERM__EXTERNAL_REFERENCE = EXPRESSION_ELEMENT__EXTERNAL_REFERENCE;
	 ...
	 * @ordered
	 */
	int TERM__ORIGIN = EXPRESSION_ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int TERM_FEATURE_COUNT = EXPRESSION_ELEMENT_FEATURE_COUNT + 1;
