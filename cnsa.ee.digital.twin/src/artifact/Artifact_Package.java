...
public interface Artifact_Package extends EPackage {
	 ...
	 * @generated
	 */
	String eNS_URI = "http://cnsa.ee.digital.twin/artifact";
	 ...
	 * @ordered
	 */
	int ARTIFACT_PACKAGE__EXTERNAL_REFERENCE = Base_Package.ARTIFACT_ELEMENT__EXTERNAL_REFERENCE;
	 ...
	 * @ordered
	 */
	int ARTIFACT_PACKAGE__INTERFACES = Base_Package.ARTIFACT_ELEMENT_FEATURE_COUNT + 1;
	 ...
	 * @generated
	 */
	int ARTIFACT_PACKAGE_INTERFACE = 1;
	 ...
	 * @ordered
	 */
	int ARTIFACT_PACKAGE_INTERFACE__EXTERNAL_REFERENCE = ARTIFACT_PACKAGE__EXTERNAL_REFERENCE;
	 ...
	 * @ordered
	 */
	int ARTIFACT_PACKAGE_INTERFACE__INTERFACES = ARTIFACT_PACKAGE__INTERFACES;
	 ...
	 * @ordered
	 */
	int ARTIFACT_PACKAGE_INTERFACE__INTERFACE_OF = ARTIFACT_PACKAGE_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int ARTIFACT_ASSET__EXTERNAL_REFERENCE = Base_Package.ARTIFACT_ELEMENT__EXTERNAL_REFERENCE;
	 ...
	 * @ordered
	 */
	int PROPERTY__EXTERNAL_REFERENCE = ARTIFACT_ASSET__EXTERNAL_REFERENCE;
	 ...
	 * @ordered
	 */
	int TECHNIQUE__EXTERNAL_REFERENCE = ARTIFACT_ASSET__EXTERNAL_REFERENCE;
	 ...
	 * @ordered
	 */
	int PARTICIPANT__EXTERNAL_REFERENCE = ARTIFACT_ASSET__EXTERNAL_REFERENCE;
	 ...
	 * @ordered
	 */
	int ACTIVITY__EXTERNAL_REFERENCE = ARTIFACT_ASSET__EXTERNAL_REFERENCE;
	 ...
	 * @ordered
	 */
	int EVENT__EXTERNAL_REFERENCE = ARTIFACT_ASSET__EXTERNAL_REFERENCE;
	 ...
	 * @ordered
	 */
	int RESOURCE__EXTERNAL_REFERENCE = ARTIFACT_ASSET__EXTERNAL_REFERENCE;
	 ...
	 * @ordered
	 */
	int ARTIFACT__EXTERNAL_REFERENCE = ARTIFACT_ASSET__EXTERNAL_REFERENCE;
	 ...
	 * @generated
	 */
	int ARTIFACT_ASSET_RELATIONSHIP = 10;
	 ...
	 * @ordered
	 */
	int ARTIFACT_ASSET_RELATIONSHIP__EXTERNAL_REFERENCE = ARTIFACT_ASSET__EXTERNAL_REFERENCE;
	...
	/**
	 * Returns the meta object for the reference list '{@link artifact.ArtifactPackage#getInterfaces <em>Interfaces</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Interfaces</em>'.
	 * @see artifact.ArtifactPackage#getInterfaces()
	 * @see #getArtifactPackage()
	 * @generated
	 */
	EReference getArtifactPackage_Interfaces();
	...
	/**
	 * Returns the meta object for the reference '{@link artifact.ArtifactPackageInterface#getInterfaceOf <em>Interface Of</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Interface Of</em>'.
	 * @see artifact.ArtifactPackageInterface#getInterfaceOf()
	 * @see #getArtifactPackageInterface()
	 * @generated
	 */
	EReference getArtifactPackageInterface_InterfaceOf();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference ARTIFACT_PACKAGE__INTERFACES = eINSTANCE.getArtifactPackage_Interfaces();
		 ...
		 * @generated
		 */
		EReference ARTIFACT_PACKAGE_INTERFACE__INTERFACE_OF = eINSTANCE.getArtifactPackageInterface_InterfaceOf();
